...
/**
 * A structure representing a singly linked list node.
 */
...
/**
 * A structure to hold pseudo-arguments for function calls.
 */
...
/**
 * A structure representing a built-in command and its associated function.
 */
...
int build_history_list(info_t *, char *, int linecount);
